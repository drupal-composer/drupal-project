...
See the detailed documentation in [Using Composer template for Drupal projects](https://www.drupal.org/docs/develop/using-composer/using-composer-template-for-drupal-projects).
